...
//—оздайте в вашем классе метод, который собирает строку дл€ вывода в файл.

std::string address::get_output_address(std::string city_name, std::string street_name, int house_number, int apartment_number)
{
    //‘ормат вывода адреса: <название города>, <название улицы>, <номер дома>, <номер квартиры>.
...
int main() {
    ...
    else if (fin.is_open())
    {
        ...
        fin >> Anum_2;
        std::cout << N << std::endl;
        //ƒл€ хранени€ всех адресов, экземпл€ров вашего класса, заведите динамический массив типа address* 
